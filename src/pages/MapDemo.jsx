...
export default function MapDemo() {
    ...
    useEffect(() => {
        ...
        const manager = new MapDemoSceneManager(canvasRef.current, {
            onLoaded: () => {
                setIsLoading(false);
            }
        });

        // OrbitControls update loop is required if damping is enabled
    ...
    return (
        <div style={{ width: '100vw', height: '100vh', backgroundColor: '#242424', position: 'relative', overflow: 'hidden' }}>
            ...
            <div style={{
                ...
                <h3 style={{ margin: '0 0 5px 0' }}>Demo Web3D</h3>
                <span style={{ fontSize: '12px', opacity: 0.8 }}>drag to rotate | scroll to zoom</span>
            </div>

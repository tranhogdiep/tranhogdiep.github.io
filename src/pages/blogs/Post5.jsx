...
export default function Post5() {
    ...
    if (language === 'vi') {
        return (
            <>
                ...
                <span className="image-caption" style={{ display: 'block', textAlign: 'center', marginTop: '-25px', marginBottom: '25px' }}>Video Minh Họa: Showroom Ô tô Three.js Tương Tác trên Nền Ngân Hà</span>
    ...
    return (
        <>
            ...
            <span className="image-caption" style={{ display: 'block', textAlign: 'center', marginTop: '-25px', marginBottom: '25px' }}>Project Demo: Interactive Three.js Car Showroom with Galaxy Background</span>

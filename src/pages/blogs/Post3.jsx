        ...
        return (
            <>
                ...
                <div className="blog-post-image-container">
                    ...
                    <span className="image-caption">Cài đặt export GLTF/GLB trong Blender hiển thị tùy chọn Draco Compression</span>
                </div>
                ...
                <p style={{ background: 'rgba(255,255,255,0.05)', padding: '10px 15px', borderRadius: '8px', fontFamily: 'monospace', textAlign: 'center', margin: '15px 0' }}>
                    4096 * 4096 * 4 bytes (RGBA) = 67.1 MB VRAM mỗi texture!
                </p>
                ...
                <pre style={{ background: 'rgba(0,0,0,0.4)', padding: '15px', borderRadius: '8px', overflowX: 'auto', color: '#38bdf8', fontFamily: 'monospace', marginBottom: '20px' }}>
                ...
                <pre style={{ background: 'rgba(0,0,0,0.4)', padding: '15px', borderRadius: '8px', overflowX: 'auto', color: '#fff', fontFamily: 'monospace', lineHeight: 1.4, marginBottom: '25px' }}>
                    npx @gltf-transform/cli optimize CSCDVN_Draco.glb CSCDVN_Optimized.glb --compress draco --texture-compress webp --texture-size 1024
                </pre>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse', margin: '25px 0', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.1)', fontSize: '0.95rem' }}>
                    <thead>
                        <tr style={{ background: 'rgba(56, 189, 248, 0.1)', borderBottom: '2px solid #38bdf8' }}>
                            <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>Phiên bản Model</th>
                            <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>Dung lượng file</th>
                            <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>Tỷ lệ nén</th>
                            <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>Ghi chú</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>CSCDVN_Origin.glb (Gốc)</td>
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', fontWeight: 'bold' }}>500.2 MB</td>
                        ...
                        <tr>
                            ...
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', fontWeight: 'bold' }}>46.62 MB</td>
                        ...
                        <tr>
                            ...
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', fontWeight: 'bold' }}>21.91 MB</td>
                        ...
                        <tr>
                            ...
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', fontWeight: 'bold' }}>16.99 MB</td>
                        ...
                        <tr style={{ background: 'rgba(46, 204, 113, 0.05)' }}>
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', color: '#2ecc71', fontWeight: 'bold' }}>gltf-transform (WebP + 1024px)</td>
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', fontWeight: 'bold', color: '#2ecc71' }}>4.82 MB</td>
                            <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', color: '#2ecc71', fontWeight: 'bold' }}>Nén ~99.0%</td>
    ...
    return (
        <>
            ...
            <div className="blog-post-image-container">
                ...
                <span className="image-caption">GLTF/GLB Export Settings in Blender showing Draco Compression option</span>
            </div>
            ...
            <p style={{ background: 'rgba(255,255,255,0.05)', padding: '10px 15px', borderRadius: '8px', fontFamily: 'monospace', textAlign: 'center', margin: '15px 0' }}>
                4096 * 4096 * 4 bytes (RGBA) = 67.1 MB VRAM per texture!
            </p>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', margin: '25px 0', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.1)', fontSize: '0.95rem' }}>
                <thead>
                    <tr style={{ background: 'rgba(56, 189, 248, 0.1)', borderBottom: '2px solid #38bdf8' }}>
                        <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>Model Version</th>
                        <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>File Size</th>
                        <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>Compression Ratio</th>
                        <th style={{ padding: '12px', textAlign: 'left', border: '1px solid rgba(255,255,255,0.1)' }}>Notes</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    ...
                    <tr style={{ background: 'rgba(46, 204, 113, 0.05)' }}>
                        <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', color: '#2ecc71', fontWeight: 'bold' }}>gltf-transform (WebP + 1024px)</td>
                        <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', fontWeight: 'bold', color: '#2ecc71' }}>4.82 MB</td>
                        <td style={{ padding: '12px', border: '1px solid rgba(255,255,255,0.1)', color: '#2ecc71', fontWeight: 'bold' }}>Compressed ~99.0%</td>
